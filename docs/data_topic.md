...
---
### Week 9 - Nov 4:[Xiao's Data Topic:Chinese General Social Survey](http://www.cnsda.org/index.php?r=projects/view&id=62072446)

### Dataset background
This is a survey for the general society circumstance  of China(2015).I will use the data selected from it to study the university enrollment and gender equality in higher education opportunities.

### Related academic Study
* Zhang Zhaoyu, Chen Qi. Gender Enlargement of Enrollment Expansion and Higher Education Opportunities in Colleges and Universities——An Empirical Analysis Based on Data from China's Comprehensive Social Survey (CGSS2008)[J].Social Sciences Research,2013,28(02):173-196 +245. (The original paper is in Chinese)
* Abstract : Since the implementation of the expansion of colleges and universities in 1999, the distribution of higher education opportunities in the gender has gradually become equal. In response to the question of “how to expand the gender equality of higher education opportunities”, this paper uses the China Comprehensive Social Survey (CGSS2008) data to focus on how the new educational opportunities after the expansion is distributed among the genders, and then explore gender. The contribution of equalization is mainly achieved by what factors. The study found that the expansion of enrollment has changed the structure of opportunities between men and women as a whole. The most important contribution comes from two aspects: one is the “second-lower cultural level” group of the junior high school, and the enrollment is expanded to this level. Women have brought more opportunities for higher education, which has contributed to the gender equality of higher education opportunities. Second, women in rural areas have their original disadvantages in the allocation of new higher education opportunities. Improvements have narrowed the gap in opportunities with men. Compared with pre-expansion, the gender equality of higher education opportunities after enrollment expansion is extending from groups with a higher level of family culture to groups with lower family culture and from non-rural areas to rural areas.
